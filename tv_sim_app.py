...
class TVSimApp:
    def __init__(self, root):
        ...
        self.root.bind("<Tab>", self.recall_last_channel)
        for i in range(10):
    ...
    def handle_digit_press(self, event):
        ...
        if self.channel_input_job: self.root.after_cancel(self.channel_input_job)
    ...
    def recall_last_channel(self, event=None):
        if self.is_changing_channel: return
        
        print(f"Recalling channel: {self.last_channel_index + 1}")
